...
class TestSegments:
    ...
    @vcr.use_cassette(
        "tests/vcr_cassettes/segments-list.yml", filter_headers=["Authorization"]
    )
    ...
    def test_given_incorrect_segment_id_when_calling_get_subscribers_list_then_type_error_is_returned(
        self,
    ):
